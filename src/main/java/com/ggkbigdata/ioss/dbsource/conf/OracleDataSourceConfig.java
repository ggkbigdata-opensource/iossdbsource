/*
 * File Name：OracleDataSourceConfig.java
 *
 * Copyrighe：copyright@2016 www.ggkbigdata.com. All Rights Reserved
 *
 * Create Time: 2016年9月20日 上午10:50:56
 */
 ...
 * @version 1.0, 2016年9月20日 上午10:50:56
 */
@Configuration
@EnableTransactionManagement
@EnableConfigurationProperties(OracleDataSourceProperties.class)
@MapperScan("com.ggkbigdata.ioss.dbsource.mapper")
public class OracleDataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.ggkbigdata.ioss.dbsource.model");
